      ...
      <div className="max-w-[680px] mx-auto px-8 py-[89px]">
        {!submitted ? (
          <motion.form initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} onSubmit={handleSubmit} className="space-y-6">
            <p className="text-gray-600 text-[16px] mb-[34px]">Tell us what you're looking for. Our team will match you with verified rental income properties in Bangalore.</p>
            ...
            <button type="submit" className="hoverable w-full py-4 bg-black text-white text-[13px] uppercase tracking-[0.1em] transition-colors hover:bg-gray-900 mt-[21px]">Submit Requirement</button>
          </motion.form>
        ) : (
