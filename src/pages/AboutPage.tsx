          ...
          <div className="flex flex-col lg:flex-row gap-[55px]">
            ...
            <div className="lg:w-[38.2%]">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }} className="text-gray-600 text-[16px] leading-[1.618]">
                ...
                <p className="mb-6">VJR Estate was formally incorporated on 15 October 2025 as VJR Estate Properties Private Limited (CIN: U68100KA2025PTC209772), with our office at 56, 12th Main Rd, Sector 6, HSR Layout, Bengaluru.</p>
                <p className="mb-6">Today, VJR Estate connects serious investors with income-producing properties backed by transparent due diligence. Every property listed is reviewed for legal clarity and rental income accuracy.</p>
              </motion.div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-[55px]">
        <div className="max-w-7xl mx-auto px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="border border-gray-200 p-[34px] text-center">
            <p className="text-gray-600 text-[16px] leading-relaxed max-w-[800px] mx-auto">We deal exclusively in Bangalore. We list only income-generating properties. We do not deal in vacant land or non-rental properties without income documentation.</p>
          </motion.div>
        </div>
      </section>
    </div>
