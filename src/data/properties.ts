import { BANGALORE_AREA_NAMES } from './bangaloreAreas';
...
/**
 * Bangalore localities used for search autocomplete & filters. Derived
 * from the canonical area directory (bangaloreAreas.ts) so the admin
 * Area/Locality picker and property search always stay in sync, plus a
 * few legacy spellings kept searchable for older records.
 */
...
export const BANGALORE_AREAS: string[] = [
